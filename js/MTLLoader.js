			...
			switch ( prop.toLowerCase() ) {
				...
				case 'usebump':
					if (istex) {
						...
						var mapHeight = THREE.ImageUtils.loadTexture( this.baseUrl + value );

						mapHeight.anisotropy = 24;
						mapHeight.repeat.set( 0.998, 0.998 );
						mapHeight.offset.set( 0.001, 0.001 )
						mapHeight.wrapS = mapHeight.wrapT = THREE.RepeatWrapping;
						mapHeight.format = THREE.RGBFormat;
						
						params[ 'bumpMap' ] = mapHeight;
				...
				case 'environment':
					params [ 'envMap' ] = HDR_BG_MAP;
					params[ 'ambient' ] = 0xe5e5e5;
					params[ 'reflectivity' ] = value;
